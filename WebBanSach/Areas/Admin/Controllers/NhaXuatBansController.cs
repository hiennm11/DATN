...
{
    public class NhaXuatBansController : BaseController
    {
        ...
        public ActionResult Create([Bind(Include = "MaNXB,TenNXB,MoTa")] NhaXuatBan nhaXuatBan)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MaNXB,TenNXB,MoTa")] NhaXuatBan nhaXuatBan)
        {
            if (ModelState.IsValid)
            {
