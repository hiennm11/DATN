...
namespace WebBanSach.Areas.Admin.Controllers
{
    public class NhaCungCapsController : BaseController
    {
        ...
        public ActionResult Create([Bind(Include = "MaNCC,TenNCC,MoTa")] NhaCungCap nhaCungCap)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MaNCC,TenNCC,MoTa")] NhaCungCap nhaCungCap)
        {
            if (ModelState.IsValid)
            {
