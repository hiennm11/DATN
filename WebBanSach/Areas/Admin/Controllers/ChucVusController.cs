...
namespace WebBanSach.Areas.Admin.Controllers
{
    public class ChucVusController : BaseController
    {
        ...
        public ActionResult Create([Bind(Include = "MaChucVu,TenChucVu,MoTa")] ChucVu chucVu)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MaChucVu,TenChucVu,MoTa")] ChucVu chucVu)
        {
            if (ModelState.IsValid)
            {
