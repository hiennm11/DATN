...
{
    public class TacGiasController : BaseController
    {
        ...
        public ActionResult Create([Bind(Include = "MaTacGia,TenTacGia,ThongTin")] TacGia tacGia)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MaTacGia,TenTacGia,ThongTin")] TacGia tacGia)
        {
            if (ModelState.IsValid)
            {
